        ...
        <body style={{backgroundColor:'#dfe8ff'}}>
            ...
            <div className="container " id="hazul">
                ...
                <div className="row text-center justify-content-center" style={{marginBottom:'20px'}}>
                    ...
                    <div className="col-lg-3 col-sm-12 " style={{backgroundColor:'#0A3BBA', borderRadius:'10px', color:'white', padding:'10px 55px'}}>   
                        <a href="" url="" style={{textDecoration: 'none', margin:'0', padding:'0'}} >
                ...
                <div className="col-1"></div>
                    ...
                    <div className="col-lg-3 col-sm-12" style={{backgroundColor:'#0A3BBA', borderRadius:'10px', color:'white', padding:'10px 70px'}}>   
                        <a href="" url="" style={{textDecoration: 'none', margin:'0', padding:'0'}} >
                ...
                {/* 
                <div className="col-3" style={{backgroundColor:'#0A3BBA', borderRadius:'10px', color:'white', padding:'10px 50px'}}>
                <img src={github} className="img-fluid, align-items-start" style={{height: '30px', paddingRight:'10px'}}></img>
                <h6 style={{display:'inline'}}>Código fonte</h6>
